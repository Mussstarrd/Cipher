...
- **Two tower families.** The **Sentry .50** reaches 10 cells and shoots the runner nearest your vault: it answers leakers down a lane. The **Chop-Shop Rotor** (magenta, spinning) reaches only 2.2 cells but grinds *everything* inside that radius at once, so it wants to sit at a corner where the crowd bunches and is useless in the open. Each has its own two-tier upgrade ladder.
