...
- **Two tower families.** The **Sentry .50** reaches 10 cells and shoots the runner nearest your vault: it answers leakers down a lane. The **Brush Hog** (a tractor mower deck, blades spinning) reaches only 2.2 cells but grinds *everything* inside that radius at once, so it wants to sit at a corner where the crowd bunches and is useless in the open. Each has its own two-tier upgrade ladder.
- **Terrain gives way.** Walls block your bullets now (they used to pass straight through), and your fire erodes them: airstrike bombs blow 120 off a map wall, rounds chip 3 on a direct hit. Your own barricades take a quarter, so a long firefight at your wall costs you something. A wall at zero opens a breach exactly like a Sapper's, and widens the same way.
