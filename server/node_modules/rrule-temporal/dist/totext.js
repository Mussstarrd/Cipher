import { r as allowedWeekdays, t as RRuleTemporal } from "./src-BY_Cxfjq.js";
...
const weekdayIndexByToken = Object.fromEntries(allowedWeekdays.map((weekday, idx) => [weekday, idx]));
...
function toText(input, locale, options = {}) {
	const opts = (typeof input === "string" ? new RRuleTemporal({ rruleString: input }) : input).options();
