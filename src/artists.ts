...
export const ARTISTS: ArtistDNA[] = [
  ...
  },
  {
    ...
    modes: [
      { id: "soul-triumph", label: "Soul triumph" },
      {
        id: "dark-minimal",
        label: "Dark minimal",
        genres: ["dark minimal rap", "industrial-tinged hip hop"],
        mood: ["cold isolation", "defiant menace", "grief under bright lights"],
        instrumentation: [
          "cavernous booming 808 drums",
          "icy synth lines",
          "distorted industrial stabs",
          "sparse haunting choir drones",
          "hollow electronic toms",
        ],
        texture: ["stark cold mix", "cavernous empty space"],
        bpm: [70, 100],
      },
    ],
  },
  {
    ...
    modes: [
      { id: "gritty-nyc", label: "Gritty NYC" },
      {
        id: "introspective",
        label: "Introspective",
        genres: ["reflective East Coast rap", "soulful New York rap"],
        mood: ["confessional honesty", "grown-man reflection", "quiet regret", "legacy weight"],
        instrumentation: [
          "stripped soul loop over dusty drums",
          "melancholy piano chords",
          "warm round bass",
          "haunting vocal sample wails",
          "sparse rimshot groove",
        ],
        texture: ["intimate late-night mix", "warm vinyl character"],
        bpm: [80, 95],
      },
      {
        id: "bounce",
        label: "Club bounce",
        genres: ["2000s East Coast club rap", "swaggering party rap"],
        mood: ["top-of-the-world celebration", "flashy player energy", "champagne-room shine"],
        instrumentation: [
          "syncopated club bounce beat",
          "chopped vocal stabs",
          "exotic woodwind loop",
          "punchy kicks and crisp claps",
          "deep club bass",
        ],
        texture: ["glossy club-ready mix", "big-room sheen"],
        bpm: [95, 112],
      },
    ],
  },
  ...
  },
  {
    ...
    modes: [
      { id: "classic-slab", label: "Classic slab" },
      {
        id: "smoky-soul",
        label: "Smoky soul",
        genres: ["smoky southern soul rap"],
        mood: ["candle-lit player reflection", "slow-burning heartache", "velvet late-night cool"],
        instrumentation: [
          "silky soul keys over knocking drums",
          "gospel organ hum",
          "slow-dripping bassline",
          "soft wah guitar murmurs",
          "airy backing-vocal harmonies",
        ],
        texture: ["smoke-filled analog warmth", "late-night lounge intimacy"],
        bpm: [72, 90],
      },
      {
        id: "modern-trunk",
        label: "Modern trunk",
        genres: ["modern Texas trap"],
        mood: ["trunk-rattling menace", "cold-eyed hustle", "big-body confidence"],
        instrumentation: [
          "sliding modern 808s under a chopped soul hook",
          "crisp swung trap hats",
          "screwed-down vocal drops",
          "dark plucked strings",
          "sub-heavy knock",
        ],
        texture: ["modern trunk-rattle master", "dark candy-paint gloss"],
        bpm: [90, 125],
      },
    ],
  },
  ...
  },
  {
    ...
    instrumentation: [
      "live orchestral brass stabs over 808 knock",
      "crisp trap hi-hat rolls",
      "plucked synth melodies",
      "marching snare rolls",
      "grand string-section swells",
      "whistling lead melodies",
    ],
    vocal: [
    ...
    modes: [
      { id: "trap-anthem", label: "Trap anthem" },
      {
        id: "smooth-player",
        label: "Smooth player",
        genres: ["smooth Atlanta rap", "southern player rap"],
        mood: ["cool-headed player poise", "silk-shirt confidence", "grown southern charm"],
        instrumentation: [
          "silky electric keys over a laid-back knock",
          "warm rolling bassline",
          "soft live orchestral horn pads",
          "gentle hi-hat shuffle",
          "twinkling music-box accents",
        ],
        texture: ["velvet Atlanta smoothness", "warm late-evening mix"],
        bpm: [88, 110],
      },
    ],
  },
  {
    id: "kevin-gates",
    displayName: "Kevin Gates",
    aliases: ["gates", "bwa"],
    genres: ["Baton Rouge street rap", "melodic southern pain rap"],
    mood: [
      "wounded warrior intensity",
      "hungry desperation",
      "brooding loyalty",
      "triumphant pain",
    ],
    groove: "behind-beat-pocket",
    grooveExtras: ["rolling Louisiana bounce"],
    instrumentation: [
      "dark rumbling 808s",
      "haunting minor piano melody",
      "eerie bell tones",
      "aggressive hi-hat rolls",
      "moody synth pads",
      "deep pulsing bass",
    ],
    vocal: [
      "gravelly melodic sung-rap",
      "pained bellowing hooks",
      "relentless breathless flow",
    ],
    texture: ["dark glossy southern mix", "heavy trunk pressure", "brooding cinematic undertone"],
    laneGuards: ["edm drop", "country"],
    bpm: [70, 145],
    adlibs: ["yeah", "huh"],
    lyricNotes: [
      "bars run breathless past the bar line, then a melodic bellow releases the pressure",
    ],
    modes: [
      { id: "pain", label: "Melodic pain" },
      {
        id: "muscle",
        label: "Street muscle",
        genres: ["hard Louisiana street rap"],
        mood: ["cold menace", "war-time focus", "no-flinch bravado"],
        instrumentation: [
          "pounding distorted 808s",
          "sinister string stabs",
          "rattling snare rolls",
          "grimy synth bass growl",
          "sparse horror-tinged keys",
        ],
        texture: ["concrete-heavy low end", "raw unpolished menace"],
        bpm: [88, 150],
      },
    ],
  },
  {
    id: "chance",
    displayName: "Chance the Rapper",
    aliases: ["chance", "chano", "lil chano"],
    genres: ["psychedelic Chicago rap", "acid soul rap"],
    mood: [
      "woozy euphoria",
      "manic joy with a dark undertow",
      "nostalgic summer haze",
      "wide-eyed wonder",
    ],
    groove: "displaced-anti-grid",
    grooveExtras: ["skittering Chicago juke swing"],
    instrumentation: [
      "warped psychedelic soul samples",
      "woozy detuned keys",
      "punchy live drums",
      "deep rolling bass",
      "hazy pitched vocal chops",
      "muted trumpet stabs",
    ],
    vocal: [
      "elastic yelping rap flow",
      "half-sung raspy melodies",
      "signature yelped ad-libs",
    ],
    texture: ["sun-warped analog haze", "gritty mixtape warmth", "psychedelic tape flutter"],
    // The soul/keys palette drifts jazzy-bright fast — guard that lane hard.
    laneGuards: ["smooth jazz", "edm drop"],
    bpm: [75, 145],
    adlibs: ["ayy", "woo"],
    lyricNotes: ["elastic phrasing that speeds and drags mid-bar; yelped ad-libs between lines"],
  },
  {
    id: "drake",
    displayName: "Drake",
    aliases: ["drizzy", "ovo", "aubrey", "champagne papi"],
    genres: ["moody Toronto rap", "nocturnal ambient trap"],
    mood: ["late-night introspection", "icy detachment", "wounded pride", "3am city glow"],
    groove: "behind-beat-pocket",
    grooveExtras: ["submerged half-time drag"],
    instrumentation: [
      "muffled low-pass filtered beat",
      "airy ambient pads",
      "deep sub-bass swells",
      "sparse muted keys",
      "filtered beat that suddenly opens up into a heavy drop",
      "distant echoing percussion",
    ],
    vocal: [
      "smooth melodic rap-sing",
      "conversational confident flow",
      "hushed doubled vocals",
    ],
    texture: ["underwater muffled warmth", "spacious nocturnal mix", "velvet-dark low end"],
    laneGuards: ["edm drop", "country"],
    bpm: [70, 100],
    adlibs: ["yeah", "uh huh"],
    lyricNotes: ["even conversational bars that slide into melody at the end of each phrase"],
  },
  {
    id: "prof",
    displayName: "Prof",
    aliases: ["prof", "gampo"],
    genres: ["rowdy midwest party rap", "Minneapolis rap"],
    mood: [
      "unhinged party menace",
      "whiskey-soaked swagger",
      "reckless humor",
      "gutter-blues abandon",
    ],
    groove: "forward-aggressive",
    grooveExtras: ["stomping bar-fight bounce"],
    instrumentation: [
      "dirty bass-heavy knock",
      "grimy blues guitar licks",
      "hard slapping drums",
      "siren-like synth whines",
      "stadium chant claps",
      "growling low synth bass",
    ],
    vocal: [
      "wild elastic rap voice flipping from growl to falsetto",
      "rowdy shouted hooks",
      "bluesy sung choruses",
      "machine-gun double-time runs",
    ],
    texture: ["raw midwest grit", "bar-basement sweat", "heavy-bottomed live mix"],
    laneGuards: ["edm drop", "country"],
    bpm: [85, 150],
    adlibs: ["ay", "woo"],
    lyricNotes: ["swing between menace and punchline humor; let the voice crack loose on hooks"],
  },
  {
    id: "weezer",
    displayName: "Weezer",
