...
export const ARTISTS: ArtistDNA[] = [
  ...
  },
  {
    id: "bob",
    displayName: "B.o.B",
    aliases: ["bobby ray", "b.o.b.", "bob"],
    genres: ["melodic southern rap", "Atlanta guitar rap"],
    mood: [
      "big-sky optimism",
      "underdog ambition",
      "festival-stage energy",
      "restless creative fire",
    ],
    groove: "behind-beat-pocket",
    grooveExtras: ["upbeat southern bounce"],
    instrumentation: [
      "strummed guitar hook over 808 knock",
      "anthemic synth leads",
      "live drum energy",
      "warm rolling bassline",
      "hand-clap accents",
      "soaring string swells",
    ],
    vocal: [
      "agile melodic rap flow",
      "clean sung anthem hooks",
      "rapid technical double-time bursts",
    ],
    texture: [
      "big festival-stage mix",
      "polished Atlanta crossover sheen",
      "warm radio-ready master",
    ],
    // Crossover-pop DNA is one step from bubblegum — guard the cutesy direction.
    laneGuards: ["bubblegum pop", "edm drop"],
    bpm: [90, 150],
    adlibs: ["yeah", "uh"],
    lyricNotes: ["verses rap-first and technical; save the singing for the anthem hook"],
  },
  {
    id: "chance",
