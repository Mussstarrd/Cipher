...
- **ADR-003 (Proposed): the premise gained an author.** A runaway AI engineers the plague; the infected keep their minds and competence (working name "the Cascade"); missions are *held*, not cleared; the syndicate-kingpin identity stays. Read `docs/decisions/ADR-003-premise-the-cascade.md` before writing any fiction, level theme or enemy. It recommends against the owner's "schizophrenia" phrasing and says why.
