...
- **`docs/design/campaign-act1.md`** is the twelve-mission Act One, rewritten 2026-09-10 for ADR-003 and ADR-004. The owner's power yard, laboratory and armoury are missions 5, 9 and 10 (now the pump house, a county facility and the fire station). Seven missions are won by a clock; mission 6 (the gate) and mission 12 (the boat ramp) cannot be won by design. Original note follows: his power yard, laboratory and armoury missions are 5, 9 and 10; seven missions are won by a clock, two cannot be won by design. Only three new enemy archetypes in the whole act. Read it before writing any mission content.
