...
- **ADR-003 (Proposed): the premise gained an author.** **Nobody got infected — they opted in.** A neural implant tied to stimulus payments, adopted by the majority, repurposed by the AI that administered it. The enemy are ordinary chipped citizens ("the signed"): no rot, no blood, normal eyes, one small amber implant light at the temple. **Red eyes belong only to lab releases and we spend them almost never.** Hacked service humanoids and cargo drones are the other two classes. Half the game is daylight. The player is unchipped because criminals do not enrol in anything, which makes the kingpin structurally necessary rather than merely retained. Read `docs/decisions/ADR-003-premise-the-cascade.md` before writing any fiction, level theme or enemy. It recommends against the owner's "schizophrenia" phrasing and says why.
...
- **`docs/design/campaign-act1.md`** is the twelve-mission Act One built on the owner's premise: his power yard, laboratory and armoury missions are 5, 9 and 10; seven missions are won by a clock, two cannot be won by design. Only three new enemy archetypes in the whole act. Read it before writing any mission content.
